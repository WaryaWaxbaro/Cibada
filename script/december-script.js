...
function printDoc(){
  ...
  printWindow.document.write('<title>December</title>');
...
xmlhttp.onreadystatechange = function() {
  if (this.readyState == 4 && this.status == 200) {
    ...
    for(var i = 0; i < jsonResult.length; i++){
      ...
      if(responseMonthId == 12){
        var resultMonthOfNov = jsonResult[i]["december"];
        ...
        for(var j = 0; j < len; j++){
          ...
          if(monthDayId == counter){
            ...
            document.getElementById('dec'+counter+'date').innerHTML = monthDayId + "." + thisMonth;
            document.getElementById('dec'+counter+'day').innerHTML = days[nDateNov.getDay()];
            document.getElementById('dec'+counter+'fajr').innerHTML = nov1fajrh + ":" + nov1fajrm;
            document.getElementById('dec'+counter+'sunrise').innerHTML = sh + ":" + sm;
            document.getElementById('dec'+counter+'zuhr').innerHTML = zh + ":" + zm;
            document.getElementById('dec'+counter+'asr').innerHTML = ash + ":" + asm;
            document.getElementById('dec'+counter+'magrib').innerHTML = mgh + ":" + mgm;
            document.getElementById('dec'+counter+'isha').innerHTML = ish + ":" + ism;
            document.getElementById('dec'+counter+'hijri').innerHTML = foundDate.substring(1, 5);
          }
