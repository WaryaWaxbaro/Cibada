...
function headDetails(){
  ...
  var nDateLast = new Date(nYear + "-" + thisMonth + "-" + "30");
...
function printDoc(){
  ...
  printWindow.document.write('<title>September</title>');
...
xmlhttp.onreadystatechange = function() {
  if (this.readyState == 4 && this.status == 200) {
    ...
    for(var i = 0; i < jsonResult.length; i++){
      ...
      if(responseMonthId == 9){
        var resultMonthOfNov = jsonResult[i]["september"];
