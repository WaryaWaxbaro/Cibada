...
function headDetails(){
  ...
  console.log("Month name is : " + foundMonthStartAgain);
  ...
  if(foundMonthStartAgain !== foundMonthStopAgain){
    ...
    foundMonthStartAgain + " - " + foundMonthStopAgain + " " + monthStop.slice(-4);
  }else{
    document.getElementById('currenthijri').textContent =
    foundMonthStartAgain + " " + monthStop.slice(-4);
  }
}
...
function printDoc(){
  ...
  printWindow.document.write('<title>November</title>');
...
xmlhttp.onreadystatechange = function() {
  if (this.readyState == 4 && this.status == 200) {
    ...
    for(var i = 0; i < jsonResult.length; i++){
      ...
      if(responseMonthId == 11){
        var resultMonthOfNov = jsonResult[i]["november"];
        ...
        for(var j = 0; j < len; j++){
          ...
          if(monthDayId == counter){
            ...
            document.getElementById('nov'+counter+'date').innerHTML = monthDayId + "." + thisMonth;
            document.getElementById('nov'+counter+'day').innerHTML = days[nDateNov.getDay()];
            document.getElementById('nov'+counter+'fajr').innerHTML = nov1fajrh + ":" + nov1fajrm;
            document.getElementById('nov'+counter+'sunrise').innerHTML = sh + ":" + sm;
            document.getElementById('nov'+counter+'zuhr').innerHTML = zh + ":" + zm;
            document.getElementById('nov'+counter+'asr').innerHTML = ash + ":" + asm;
            document.getElementById('nov'+counter+'magrib').innerHTML = mgh + ":" + mgm;
            document.getElementById('nov'+counter+'isha').innerHTML = ish + ":" + ism;
            document.getElementById('nov'+counter+'hijri').innerHTML = foundDate.substring(1, 5);
          }
          /*if(monthDayId == 2){
            var nDateNov = new Date(nYear + "-" + thisMonth + "-" + monthDayId);
            //var nDateNov = new Date("2018-11-1");
            ...
            var secondIndex = localeOptions.indexOf("/");
            var foundDate = localeOptions.substring(firstIndex, secondIndex);
            console.log("ddd :" + foundDate.substring(1, 5));

            document.getElementById('nov2date').innerHTML = monthDayId + "." + thisMonth;
            document.getElementById('nov2day').innerHTML = days[nDateNov.getDay()];
            document.getElementById('nov2fajr').innerHTML = nov1fajrh + ":" + nov1fajrm;
            document.getElementById('nov2sunrise').innerHTML = sh + ":" + sm;
            document.getElementById('nov2zuhr').innerHTML = zh + ":" + zm;
            document.getElementById('nov2asr').innerHTML = ash + ":" + asm;
            document.getElementById('nov2magrib').innerHTML = mgh + ":" + mgm;
            document.getElementById('nov2isha').innerHTML = ish + ":" + ism;
            document.getElementById('nov2hijri').innerHTML = foundDate.substring(1, 5);
          }
          if(monthDayId == 3){
            var nDateNov = new Date(nYear + "-" + thisMonth + "-" + monthDayId);
            //var nDateNov = new Date("2018-11-1");
            ...
            document.getElementById('nov3date').innerHTML = monthDayId + "." + thisMonth;
            document.getElementById('nov3day').innerHTML = days[nDateNov.getDay()];
            document.getElementById('nov3fajr').innerHTML = nov1fajrh + ":" + nov1fajrm;
            document.getElementById('nov3sunrise').innerHTML = sh + ":" + sm;
            document.getElementById('nov3zuhr').innerHTML = zh + ":" + zm;
            document.getElementById('nov3asr').innerHTML = ash + ":" + asm;
            document.getElementById('nov3magrib').innerHTML = mgh + ":" + mgm;
            document.getElementById('nov3isha').innerHTML = ish + ":" + ism;
            document.getElementById('nov3hijri').innerHTML = foundDate.substring(1, 5);
          }*/
        }
      }
    }
